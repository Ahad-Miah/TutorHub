                ...
                <div className="max-w-7xl mx-auto px-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div className="flex flex-col items-center bg-white bg-opacity-10 rounded-lg p-6 shadow-md hover:scale-105 transform transition duration-300">
                            ...
                            <h3 className="text-3xl font-semibold">{counterOn && <CountUp end={1200} duration={1} delay={0} />}+</h3>
                        ...
                        <div className="flex flex-col items-center bg-white bg-opacity-10 rounded-lg p-6 shadow-md hover:scale-105 transform transition duration-300">
                            ...
                            <h3 className="text-3xl font-semibold">{counterOn && <CountUp end={25} duration={3} delay={0} />}+</h3>
                            <p className="text-lg mt-2">Languages Supported</p>
                        </div>
                        {/* Users Count */}
                        <div className="flex flex-col items-center bg-white bg-opacity-10 rounded-lg p-6 shadow-md hover:scale-105 transform transition duration-300">
                            <FaUsers className="text-4xl text-pink-400 mb-4" />
                            <h3 className="text-3xl font-semibold">{counterOn && <CountUp end={10000} duration={1} delay={0} />}+</h3>
